...
class MoreOptionsList extends StatelessWidget {
  final List<List> _moreOptionsList = const [
    ...
    [MdiIcons.facebookMessenger, Palette.primaryCyan, 'Messenger'],
    [MdiIcons.flag, Colors.orange, 'Pages'],
    [MdiIcons.storefront, Palette.primaryCyan, 'Marketplace'],
    [Icons.ondemand_video, Palette.primaryCyan, 'Watch'],
